      ...
      >
        ...
        >
            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-5 items-center">
                <div className="compaire relative">
                  ...
                  <span className="w-[18px] h-[18px] rounded-full bg-qyellow absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px] text-white">
                    2
                  </span>
                </div>
          ...
          <div className="w-full mt-5 px-5">
            <div className="search-bar w-full h-[34px] flex rounded-s-lg">
              <div className="flex-1 bg-white h-full border border-r-0 border-[#E9E9E9] rounded-s-lg">
                <input
                  value={searchKey}
              ...
              <div
                ...
                className="cursor-pointer w-[40px] h-full bg-qyellow flex justify-center items-center rounded-e-lg"
              >
                <span>
                  <svg
                    width="23"
