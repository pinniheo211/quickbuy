...
export default function ProductCardStyleOne({ datas }) {
  ...
  return (
    <div className="main-wrapper-card relative rounded-lg hover:shadow-lg hover:-translate-y-1 transition-all ease-in duration-300">
      <div
        className="product-card-one w-full h-full bg-white relative group overflow-hidden rounded-lg "
        style={{ boxShadow: "0px 15px 64px 0px rgba(0, 0, 0, 0.05)" }}
      >
        {/* <div className="overlay z-[1] absolute top-0 left-0 w-full h-full bg-black opacity-0 transition-opacity duration-300 ease-in-out hover:opacity-50"></div> */}
        <div className="product-card-img w-full h-[200px] -mt-2">
        ...
        <div className="product-card-details px-[10px] pb-[30px] relative pt-2">
          {/* add to card button */}
          <div className="absolute w-full h-10 px-[30px] left-0 top-[200px] group-hover:top-[78px] transition-all duration-300 ease-in-out">
            <button
              onClick={() => addToCart(datas.id)}
              type="button"
              className="yellow-btn group relative w-full h-full flex shadow  justify-center items-center overflow-hidden rounded-lg"
            >
              ...
              <div className="bg-shape w-full h-full absolute  bg-gradient-button"></div>
            </button>
          </div>
          {datas.review && (
          ...
          >
            <a rel="noopener noreferrer">
              <p className="title mb-2  overflow-ellipsis text-[15px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600 cursor-pointer">
                {datas.title}
              </p>
            </a>
          </Link>
        ...
        <div className="quick-access-btns flex flex-col space-y-2">
          ...
          <button
            className="w-10 h-10 absolute group-hover:right-4 -right-10 top-[120px] transition-all duration-300 ease-in-out"
            type="button"
            // onClick={() => addToWishlist(datas.id)}
          >
            <span className="w-10 h-full flex text-black hover:text-white justify-center items-center transition-all duration-300 ease-in-out hover:bg-qyellow bg-primarygray rounded-lg">
              <ThinLove className={`duration-75 transition-all fill-current`} />
            </span>
          </button>
        </div>
      </div>
